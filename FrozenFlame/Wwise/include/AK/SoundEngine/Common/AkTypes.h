...
static const AkAuxBusID					AK_INVALID_ENV_ID					=  AK_INVALID_UNIQUE_ID;///< Invalid environment ID (or no environment ID) *DEPRECATED
static const AkAuxBusID					AK_INVALID_AUX_ID					=  AK_INVALID_UNIQUE_ID;///< Invalid auxilliary bus ID (or no Aux bus ID)
...
/// Auxilliary bus sends information per game object per given auxilliary bus.
