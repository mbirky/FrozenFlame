...
#pragma pack(pop)
...
#ifdef AK_USE_THREAD_EMULATION
       *out_pThread = ThreadEmulation::CreateThread( NULL,							// No security attributes
                                       0,	// StackSize (0 uses system default)
    ...
    {
#ifdef AK_USE_THREAD_EMULATION
		ThreadEmulation::Sleep( in_ulMilliseconds );
#else
