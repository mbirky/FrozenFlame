...
namespace PlatformID
{
	...
	const GUID VitaSW = { 0x2db55050, 0x4b70, 0x4243, { 0xa2, 0x2c, 0x43, 0x4d, 0x77, 0x6a, 0x7, 0x53 } };
	
	// {091EBCFF-5E04-4260-B025-566206272EA6}
	const GUID VitaHW = { 0x91ebcff, 0x5e04, 0x4260, { 0xb0, 0x25, 0x56, 0x62, 0x6, 0x27, 0x2e, 0xa6 } };
	...
	const GUID WiiUSW = { 0x7cb75869, 0x58ad, 0x4458, { 0x94, 0x8a, 0x19, 0x35, 0xcc, 0xb4, 0xac, 0x66 } };

	// {FF757AE1-FCE5-420d-9E8A-32139D436F74}
	const GUID WiiUHW = { 0xff757ae1, 0xfce5, 0x420d, { 0x9e, 0x8a, 0x32, 0x13, 0x9d, 0x43, 0x6f, 0x74 } };

	// {a2d401de-b8b6-4feb-8142-137c34d507CA}
	const GUID Android = { 0xa2d401de, 0xb8b6, 0x4feb, { 0x81, 0x42, 0x13, 0x7c, 0x34, 0xd5, 0x07, 0xCA } };
