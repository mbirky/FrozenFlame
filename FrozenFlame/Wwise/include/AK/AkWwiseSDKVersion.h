...
#define AK_WWISESDK_VERSION_BUILD				4427
...
//@{
	...
	#define AK_WWISESDK_COPYRIGHT 				"\xA9 Audiokinetic Inc. 2006-2012. All rights reserved."
#endif
	/// Wwise SDK copyright notice
	#define AK_WWISESDK_COPYRIGHT_CONSOLE 		"(C) Audiokinetic Inc. 2006-2012. All rights reserved."
//@}
