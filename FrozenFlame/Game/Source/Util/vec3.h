...
public:
   ...
   friend vec3<T> interpolateVector(const_reference vectorA, const_reference vectorB, float lamda)
   {
...
// typedef to create an alias for vec3f named float3
typedef vec3f float3;
// typedef to create an alias for vec3d named double3
